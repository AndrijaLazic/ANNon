...
namespace Projekat2.Migrations
{
    ...
    [Migration("20220302155256_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Projekat2.Inspection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Projekat2.InspectionType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Projekat2.Status", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Projekat2.Inspection", b =>
                {
                    b.HasOne("Projekat2.InspectionType", "InspectionType")
                        .WithMany()
